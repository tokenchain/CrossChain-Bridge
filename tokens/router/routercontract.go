...
// SetChainIDs abi
func SetChainIDs(chainIDs []string) (err error) {
	return
}

// AddChainIDs abi
func AddChainIDs(chainIDs []string) (err error) {
	return
}

// RemoveChainID abi
func RemoveChainID(chainID string) (err error) {
	return
}

// SetTokenID abi
func SetTokenID(chainID, tokenAddr, tokenID string) (err error) {
	return
}

// SetTokenIDs abi
func SetTokenIDs(tokenIDs []string) (err error) {
	return
}

// AddTokenIDs abi
func AddTokenIDs(tokenIDs []string) (err error) {
	return
}

// RemoveTokenID abi
func RemoveTokenID(tokenID string) (err error) {
	return
}

// AddPeerTokens abi
func AddPeerTokens(tokenID string, chainID, tokens []string) (err error) {
	return
}

// AddPeerToken abi
func AddPeerToken(tokenID, chainID, token string) (err error) {
	return
}

// RemovePeerToken abi
func RemovePeerToken(tokenID, chainID, token string) (err error) {
	return
}

// SetChainConfig abi
func SetChainConfig(chainID string, data []byte) (err error) {
	return
}

// SetTokenConfig abi
func SetTokenConfig(tokenID, chainID, tokenAddr string, data []byte) (err error) {
	return
}

// SetUserTokenConfig abi
func SetUserTokenConfig(chainID, tokenAddr string, data []byte) (err error) {
	return
}

// PickUserTokenConfig abi
func PickUserTokenConfig(tokenID, chainID, tokenAddr string) (err error) {
	return
}

// SetCustomConfig abi
func SetCustomConfig(chainID, key string, data []byte) (err error) {
	return
}

// SetMPCPubkey abi
func SetMPCPubkey(addr string, data []byte) (err error) {
	return
}

// SetMPCPubkey2 abi
func SetMPCPubkey2(addr string, data []byte) (err error) {
	return
}
